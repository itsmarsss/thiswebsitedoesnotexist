...
interface IconProps extends SVGProps<SVGSVGElement> {
    type: "refresh" | "sparkles" | "dice" | "download" | "share" | "home";
}
...
export default function Icon({
    ...
    // Define gradients for each icon type
    const gradients = {
        refresh: {
            id: "refreshGradient",
            stops: [
        ...
        sparkles: {
            ...
            stops: [
                ...
                { offset: "100%", color: "#8B5CF6" }, // violet-500
            ],
        },
        dice: {
            id: "diceGradient",
        ...
        download: {
            ...
            stops: [
                ...
                { offset: "100%", color: "#EF4444" }, // red-500
            ],
        },
        share: {
            id: "shareGradient",
            stops: [
                ...
                { offset: "100%", color: "#EC4899" }, // pink-500
            ],
        },
        home: {
            id: "homeGradient",
    ...
    return (
        ...
        >
            ...
            <g stroke={`url(#${gradient.id})`}>{icons[type]}</g>
        </svg>
    );
}
